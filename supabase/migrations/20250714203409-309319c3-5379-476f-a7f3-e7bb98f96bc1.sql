-- Remove the existing trigger that awards credits on successful appeals
DROP TRIGGER IF EXISTS award_credits_on_successful_appeal ON public.appeal_status;
DROP FUNCTION IF EXISTS public.award_referral_credits();
