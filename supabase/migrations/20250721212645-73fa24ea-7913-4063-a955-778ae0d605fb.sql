-- Remove all conflicting check constraints on appeal_status
ALTER TABLE public.protests DROP CONSTRAINT IF EXISTS appeal_status_appeal_status_check;
ALTER TABLE public.protests DROP CONSTRAINT IF EXISTS appeal_status_exemption_status_check;
ALTER TABLE public.protests DROP CONSTRAINT IF EXISTS protests_appeal_status_check;

-- Insert simple mock protest data
