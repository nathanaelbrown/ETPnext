-- Create foreign key relationship between properties and protests
ALTER TABLE public.protests 
ADD CONSTRAINT fk_protests_property_id 
FOREIGN KEY (property_id) REFERENCES public.properties(id);

-- Insert sample properties that correspond to existing protests for the mock user
...
-- Update existing protests to reference these properties
